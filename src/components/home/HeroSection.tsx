  ...
  return (
    <section className="relative min-h-[100vh] flex items-center">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-32 md:px-6">
        ...
        >
          <span 
            className="inline-block px-4 py-2 rounded-full text-xl md:text-2xl font-display tracking-wider bg-[#ff4742]/10 text-[#ff4742] mb-8"
            style={{ WebkitTextStroke: '1px black', textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}
          >
            Circus Entertainer
          </span>
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight text-shadow-md mb-10">Hunter Way</h1>
