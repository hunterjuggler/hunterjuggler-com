  ...
  return (
    <section className="relative min-h-[100vh] flex items-center">
      <div className="absolute inset-0 z-0">
        <BlurImage src="/lovable-uploads/c6378360-43f1-4aaf-83e7-4d6a74ede8a6.png" alt="Hunter Way performing" className="w-full h-full object-cover hero-mask integrated-image" />
