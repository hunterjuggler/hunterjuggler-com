      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          once: true
            ...
            <p className="text-muted-foreground mb-6">With over two decades of experience in circus arts and over a decade of performing it, I've dedicated my life to perfecting my craft and creating unforgettable experiences for audiences around the world.</p>
          ...
          once: true
            ...
            <BlurImage src="/lovable-uploads/caccdc20-e85d-443a-93d6-8500b3024c84.png" alt="Hunter Way performing" aspectRatio="portrait" className="w-full h-full object-cover integrated-image" />
          </motion.div>
        </div>
      </div>
    </section>;
